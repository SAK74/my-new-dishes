import { Container, Stepper, Step, StepLabel, Paper, AppBar, Toolbar } from '@mui/material';
import {Typography, IconButton, Drawer, FormControlLabel, Switch as MuiSwitch, switchClasses} from '@mui/material';
...
export default function Main() {
  ...
  return (
    <ThemeProvider theme = {theme}>
      <AppBar>
        <Toolbar>
          <Typography variant = 'h4' children = "My dishes App" sx = {{flex: 1}}/>
          <IconButton children = {<Settings/>} onClick = {() => setDrawer(true)}/>
        </Toolbar>
      </AppBar>
      <Ofset/>
      ...
      sx = {{
        ...
        <MemoryRouter>
          ...
          <Route render = {({location}) => {
            ...
            return <Stepper activeStep = {step} alternativeLabel sx = {{width: '90%', my: 5}}>
